...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	Моля добавяйте повече РЕАЛНИ данни, за да получим реална статистика. 
	Може да сортирате по брой мнения, средна оценка, име на квартала или 
	Средната оценка е сумата на всички критерии, разделено на броя им.<br> <br>
	Под публични сгради се разбират училища, детски градини,  общини и всички учреждения, които държавата осигурява.
	Критериите са 8, тъй като в противен случай ще се налага да се въвеждат прекалено много неща. 
